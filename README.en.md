...
- **Practical on compact screens**: Delegations, plans, and archives use list → single detail → back navigation on mobile instead of squeezing a short list above a long record; desktop retains the two-pane layout.
