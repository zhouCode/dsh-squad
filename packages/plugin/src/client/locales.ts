...
export const zh = {
  ...
  "sync.CONNECTING": "正在连接本机实时更新",
  "sync.LIVE": "本机状态实时同步中",
  "sync.RECONNECTING": "实时连接中断，正在重连",
  "sync.STALE": "当前状态可能已过期",
  ...
  "relayOps.title": "Relay 运维概览",
  "relayOps.intro": "仅展示当前 Relay 主机上的聚合运行指标，不读取任务内容。",
  "relayOps.capturedAt": "采集于 {time}",
  "relayOps.runtime": "运行态",
  "relayOps.startedAt": "本次启动",
  "relayOps.connectedNodes": "已连接邮箱的节点",
  "relayOps.liveConnections": "实时邮箱连接",
  "relayOps.requestLimit": "每节点每分钟请求上限",
  "relayOps.nodes": "节点登记",
  "relayOps.active": "活动",
  "relayOps.disabled": "已禁用",
  "relayOps.enrollmentInvitations": "可用登记邀请",
  "relayOps.mailbox": "持久邮箱",
  "relayOps.pending": "未确认信封",
  "relayOps.mailboxLimit": "每节点容量上限",
  "relayOps.oldestPending": "最早待收取",
  "relayOps.organizations": "组织目录",
  "relayOps.dissolved": "已解散",
  "relayOps.pendingJoins": "待审批加入",
  "relayOps.organizationInvitations": "有效组织邀请",
  "relayOps.privacyHint":
    "这些数字来自 Relay 本机数据库与实时连接表，不包含信封正文、成员凭据或个人 Agent 工作区。",
  "relayOps.remoteHint":
    "远端 Relay 不通过节点接口公开运维指标；请在运行 Relay 的 DSH WebUI 中查看。",
...
export const en = {
  ...
  "sync.CONNECTING": "Connecting local live updates",
  "sync.LIVE": "Local state is live",
  "sync.RECONNECTING": "Live updates interrupted; reconnecting",
  "sync.STALE": "The current snapshot may be stale",
  ...
  "relayOps.title": "Relay operations",
  "relayOps.intro":
    "Aggregate runtime metrics from this Relay host only; task content is never read.",
  "relayOps.capturedAt": "Captured {time}",
  "relayOps.runtime": "Runtime",
  "relayOps.startedAt": "Current start",
  "relayOps.connectedNodes": "Nodes with live mailboxes",
  "relayOps.liveConnections": "Live mailbox connections",
  "relayOps.requestLimit": "Requests per Node per minute",
  "relayOps.nodes": "Node enrollment",
  "relayOps.active": "Active",
  "relayOps.disabled": "Disabled",
  "relayOps.enrollmentInvitations": "Available enrollment invitations",
  "relayOps.mailbox": "Durable mailbox",
  "relayOps.pending": "Unacknowledged envelopes",
  "relayOps.mailboxLimit": "Capacity per Node",
  "relayOps.oldestPending": "Oldest pending",
  "relayOps.organizations": "Organization directory",
  "relayOps.dissolved": "Dissolved",
  "relayOps.pendingJoins": "Pending joins",
  "relayOps.organizationInvitations": "Active organization invitations",
  "relayOps.privacyHint":
    "These counts come from the Relay-local database and live connection table; they contain no envelope body, member credential, or Personal Agent workspace data.",
  "relayOps.remoteHint":
    "A remote Relay does not expose operations metrics through Node APIs. Open the DSH WebUI on the Relay host to inspect them.",
